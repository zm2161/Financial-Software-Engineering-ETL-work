...
sys.path.append(os.path.dirname(os.path.dirname(
    os.path.dirname(os.path.dirname(os.path.abspath('etldata.py'))))))
...
def main(argv):
    ...
    try:
        ...
        # Preparation step.
        mapping_args = convertu.convert_namespace(args)
        mapping_conf = convertu.convert_namespace(feature_config)
